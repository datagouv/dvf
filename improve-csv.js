...
function convertRow(row, {culturesMap, culturesSpecialesMap}) {
  ...
  const converted = {
    ...
    lot2_surface_carrez: parseFloat(row['Surface Carrez du 2e lot']) || '',
    lot3_numero: row['3e lot'],
    lot3_surface_carrez: parseFloat(row['Surface Carrez du 3e lot']) || '',
    lot4_numero: row['4e lot'],
    lot4_surface_carrez: parseFloat(row['Surface Carrez du 4e lot']) || '',
    lot5_numero: row['5e lot'],
    lot5_surface_carrez: parseFloat(row['Surface Carrez du 5e lot']) || '',
